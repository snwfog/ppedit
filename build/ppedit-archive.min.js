...
b);null==d||0===d?this._getRowContainer(a).find(".right-sidebar-menu2").prepend(e):e.insertBefore(this._getRowContainer(a).find(".ppedit-panel-row:nth-child("+(d+1)+")"));e.find(".ppedit-slider").slider({min:0,max:100,step:1,value:100}).on("slideStart",function(a){return f.prevOpacityVal=$(a.target).val()||100}).on("slide",function(a){var c;c=$(a.target).val();d=e.parents(".ppedit-row-container").index()-1;return $(a.target).trigger("onRowSliderValChanged",[d,b,parseInt(c)/100])}).on("slideStop",
function(a){var c;c=$(a.target).val();d=e.parents(".ppedit-row-container").index()-1;f.prevOpacityVal!==c&&$(a.target).trigger("onRowSliderStopValChanged",[d,b,parseInt(f.prevOpacityVal)/100,parseInt(c)/100]);return f.prevOpacityVal=void 0});e.find(".deleteElementBtn").on("click",function(a){d=e.parents(".ppedit-row-container").index()-1;return $(a.target).trigger("onRowDeleteBtnClick",[d,b])});return e.find("input").blur(function(a){var c;c=$(a.target).val();if(c!==f.prevBoxNameVal[b])return d=e.parents(".ppedit-row-container").index()-
...
return a}(E);(function(b,a,c){var d,e,g,f;d=void 0;f={"default":"cool!"};g=null;e={init:function(a){d=b(this);b.extend(f,a||{});g=new K(d);g.buildElement();d.append(g.element);g.bindEvents();if(null!=f.onload)f.onload();return d},doSomething:function(a){return d},destroy:function(){return d},save:function(){return g.commandManager.getUndoJSON()},allHunks:function(){return g.area.boxesContainer.getAllHunks()},clearHistory:function(){g.commandManager.clearHistory();return d},load:function(a){g.load(a.hunks);
return d}};return b.fn.ppedit=function(a){return e[a]?e[a].apply(this,Array.prototype.slice.call(arguments,1)):"object"!==typeof a&&a?b.error("Method "+a+" does not exist on jquery.ppedit"):e.init.apply(this,arguments)}})(jQuery,window,document)}).call(this);