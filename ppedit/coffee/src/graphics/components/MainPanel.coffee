  ...
  buildElement: ->
    @element = $('
            <div class="left-sidebar">
              <img class="icon-set undoImg" src="./ppedit/img/icons/ON/glyphicons_221_unshare.png">
              <img class="icon-set redoImg" src="./ppedit/img//icons/ON/glyphicons_222_share.png">
              <img class="icon-set gridImg" src="./ppedit/img/icons/ON/glyphicons_155_show_big_thumbnails.png">
              <img class="icon-set snapImg" src="./ppedit/img/icons/ON/glyphicons_023_magnet.png">
          </div>')
