...
(function() {
  var Box, BoxesContainer, Canvas, CommandManager, Controller, CreateBoxCommand, EditorManager, Grid, MoveBoxCommand, PCController, Panel, RemoveBoxesCommand,
  ...
  BoxesContainer = (function() {
    ...
    */
    ...
    BoxesContainer.prototype.createBox = function(options) {
      ...
      this.commandManager.pushCommand(createBoxCommand);
      return createBoxCommand.box;
    };

    BoxesContainer.prototype.removeBox = function(options) {
      return this.commandManager.pushCommand(new RemoveBoxesCommand(this));
    };
    ...
    */
    ...
    BoxesContainer.prototype.deleteSelectedBoxes = function() {
      ...
      if (selectedBoxes.length > 0) {
        return this.commandManager.pushCommand(new RemoveBoxesCommand(this, selectedBoxes));
      }
    };
    ...
    function PCController(root) {
      ...
      this.editorManager.root.keydown(function(event) {
        if (event.keyCode === 90 && event.ctrlKey) {
          event.preventDefault();
          _this.editorManager.boxesContainer.commandManager.undo();
        }
        if (event.keyCode === 89 && event.ctrlKey) {
          event.preventDefault();
          _this.editorManager.boxesContainer.commandManager.redo();
        }
