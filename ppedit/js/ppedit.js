...
(function() {
  var Box, BoxesContainer, Canvas, Controller, CreateBoxCommand, EditorManager, Grid, ICommand, MoveBoxCommand, PCController, Panel, RemoveBoxesCommand,
  ...
  BoxesContainer = (function() {
    ...
    */
    ...
    BoxesContainer.prototype.boxesFromSelector = function(selector) {
      return this.element.find(selector).each(function() {});
    };
  ...
  RemoveBoxesCommand = (function(_super) {
    ...
    */
    ...
    function RemoveBoxesCommand(root, boxesContainer, boxesSelector) {
      var box, boxArray;
      this.root = root;
...
\
  ...
  EditorManager = (function() {
    ...
    EditorManager.prototype.deleteSelectedBoxes = function() {
      var selectedBoxes;
      selectedBoxes = $('.ppedit-box:focus, .ppedit-box-selected');
      if (selectedBoxes.length > 0) {
        return this.pushCommand(new RemoveBoxesCommand(this.boxesContainer.element, this.boxesContainer, selectedBoxes));
      }
    };
    ...
    function PCController(root) {
      ...
      this.editorManager.root.keydown(function(event) {
        ...
        if (event.keyCode === 46 || (event.keyCode === 46 && event.ctrlKey)) {
          event.preventDefault();
          return _this.editorManager.deleteSelectedBoxes();
        }
      });
    }
