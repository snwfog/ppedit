...
(function() {
  var addBox, enterText, moveBox, ppeditDescribe, ppeditMatchers, selectRectangle, viewPortPosition;
  ...
  */
  ...
  /*
  Simulates entering the specified into the passed box
  */
  ...
  ppeditDescribe('A test for issue CAP-132 : "Add a load content API on PPedit"', function() {
    ...
    it("can load 1 box", function() {
      ...
      $('.editor').ppedit('load', {
        jsonBoxes: JSON.stringify(singleBoxObject)
      });
      return expect($('.ppedit-box')).toHaveLength(1);
    });
    ...
    return it("can load 4 boxes with some contents in each", function() {
      $('.editor').ppedit('load', {
        jsonBoxes: JSON.stringify(boxObjects)
      });
